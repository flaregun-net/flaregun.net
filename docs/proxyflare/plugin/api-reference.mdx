...
This reference documentation will evolve in a more user friendly direction over time.
...
export type Route = {
  ...
  to: {
     ...
     * ✅ Proxies traffic on `a.com/images/*` to `my-site.com`
     *
     * @example
     ...
     * ✅ Proxies the script to `my-site.com`
     */
    resources?: string[]
    /**
