...
slug: security-disclosure/index
---
...
Join the [Hasura Security Announcements](https://groups.google.com/forum/#!forum/hasura-security-announce) group for emails about security announcements.
...
In these cases you can join our [Discord server](https://hasura.io/discord) where the community will be happy to help you out.
