...
- Use the GraphiQL interface in the console to make a request and send
  the session variables as request headers (_send a_ `X-Hasura-Role`
  _key, with its value as the name of the role you've defined rules
  for_). The data in the response will be restricted as per your
  configuration.
