...
We can work around this limitation by using [views](/graphql/core/databases/postgres/schema/views.mdx).
...
[Create a view](/graphql/core/databases/postgres/schema/views.mdx#pg-create-views) called `user_private` with columns
...
[create a manual object relationship](/graphql/core/databases/postgres/schema/table-relationships/create.mdx#pg-create-manual-relationships)
