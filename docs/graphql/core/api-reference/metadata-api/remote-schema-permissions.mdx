...
## add_remote_schema_permissions {#metadata-add-remote-schema-permissions}
...
### Remote Relationship Permissions {#metadata-remote-relationship-permissions}
...
### Args syntax {#metadata-add-remote-schema-permissions-syntax}
...
### Args syntax {#metadata-drop-remote-schema-permissions-syntax}
