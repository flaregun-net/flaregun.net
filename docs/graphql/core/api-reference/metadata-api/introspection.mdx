...
| ------------------ | -------- | ------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| disabled_for_roles | true     | Array of [RoleName](/graphql/core/api-reference/syntax-defs.mdx#rolename) | Roles for which GraphQL schema introspection should be disabled _(supported only in cloud/enterprise versions)_ |
