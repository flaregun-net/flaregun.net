...
_You can skip this step if you are using a 3rd party GraphQL API or already have a functional GraphQL server that meets your requirements._
...
- Types with the _exact same name and structure_ will be merged. But types with the _same name but different structure_ will result in type conflicts.
