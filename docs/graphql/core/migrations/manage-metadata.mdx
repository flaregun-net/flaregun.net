...
## Exporting Hasura metadata {#exporting-metadata}
...
via the CLI or the [cli-migrations](/graphql/core/migrations/advanced/auto-apply-migrations.mdx) image only.

:::

## Applying/Importing Hasura metadata {#applying-metadata}
...
## Reloading Hasura metadata {#reload-metadata-manual}
...
## Resetting Hasura metadata {#reset-metadata-manual}
...
take a look at the [cli-migrations](/graphql/core/migrations/advanced/auto-apply-migrations.mdx) Docker
