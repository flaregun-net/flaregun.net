---
sidebar_label: Rolling back applied migrations
sidebar_position: 3
...
For `config v2`, see [Rolling back applied migrations (config v2)](/graphql/core/migrations/config-v2/advanced/rolling-back-migrations.mdx).
