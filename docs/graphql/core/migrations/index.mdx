---
title: Migrations & Metadata (CI/CD)
...
`v2.0.0-alpha.1`. (See [upgrade guide](/graphql/core/migrations/upgrade-v3.mdx)).

For `config v2`, see [Migrations (config v2)](/graphql/core/migrations/config-v2/index.mdx).
...
See [Setting up Hasura Migrations](/graphql/core/migrations/migrations-setup.mdx).
