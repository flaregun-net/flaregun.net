...
described [here](#telemetry-optout).
...
The Console collects runtime errors along with
...
```json
{
  ...
  "data": {
    "message": "Uncaught TypeError: something is not a function",
    "stack": [" at main.js:1:3"]
  }
}
```
