...
for your MySQL database _(replace the values surrounded by \<\>)_
...
the appropriate value for `mysql-host`. _(See Hasura to API)_
...
managed externally as of now. _(support for this is coming very soon)_
