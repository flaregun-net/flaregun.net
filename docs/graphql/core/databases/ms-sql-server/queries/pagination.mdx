...
arguments in the [API reference](/graphql/core/api-reference/graphql-api/query.mdx#paginationexp).
...
## Limit results in a nested object {#ms-sql-server-nested-paginate}
...
[subscriptions](/graphql/core/databases/ms-sql-server/subscriptions/index.mdx), two subscriptions will
need to be run as Hasura follows the [GraphQL spec](https://graphql.github.io/graphql-spec/June2018/#sec-Single-root-field)
