...
<Thumbnail
  src="/img/graphql/core/schema/add-foreign-key-mssql.png"
...
[view](graphql/core/databases/ms-sql-server/schema/views.mdx) `author_avg_rating (id, avg)` which
...
- **Reference** will be: `id -> author_avg_rating . id` _(similar to
  defining a foreign-key)_
