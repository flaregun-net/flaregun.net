...
See the [update mutation API reference](/graphql/core/api-reference/graphql-api/mutation.mdx#update-syntax) for the full
specifications.
...
<TOCInline toc={toc} filterTOC={(tocTree) => tocTree[6].children} />
