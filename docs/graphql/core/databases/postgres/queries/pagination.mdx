...
If this needs to be done over [subscriptions](/graphql/core/databases/postgres/subscriptions/index.mdx), two
subscriptions will need to be run as Hasura follows the [GraphQL spec](https://graphql.github.io/graphql-spec/June2018/#sec-Single-root-field)
