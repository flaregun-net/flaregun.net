...
[relationships](/graphql/core/databases/postgres/schema/table-relationships/index.mdx) defined in your schema to make
...
You can also [filter](/graphql/core/databases/postgres/queries/query-filters.mdx#pg-nested-filter), [sort](/graphql/core/databases/postgres/queries/sorting.mdx#pg-nested-sort),
[aggregate](/graphql/core/databases/postgres/queries/aggregation-queries.mdx#pg-nested-aggregate) and [paginate](/graphql/core/databases/postgres/queries/pagination.mdx#pg-nested-paginate)
