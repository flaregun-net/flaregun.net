...
to the [API reference](/graphql/core/api-reference/graphql-api/query.mdx#generic-operators).
...
equivalents, refer to the [API reference](/graphql/core/api-reference/graphql-api/query.mdx#generic-operators).
...
refer to the [API reference](/graphql/core/api-reference/graphql-api/query.mdx#text-operators).
...
the [API reference](/graphql/core/api-reference/graphql-api/query.mdx#jsonb-operators).
...
equivalents, refer to the [API reference](/graphql/core/api-reference/graphql-api/query.mdx#geometry-operators).

Use JSON representation (see [GeoJSON](https://tools.ietf.org/html/rfc7946)) of `geometry` and
...
refer to the [API reference](/graphql/core/api-reference/graphql-api/query.mdx#null-expression).
...
submit a feature request via [GitHub](https://github.com/hasura/graphql-engine) if you want support
for more functions.

For more details on intersect operators on raster columns and Postgres
equivalents, refer to the [API reference](/graphql/core/api-reference/graphql-api/query.mdx#intersect-operators).
...
Please submit a feature request via [GitHub](https://github.com/hasura/graphql-engine) if you want support
for more functions.

For more details on `ltree` operators and Postgres equivalents, refer to
the [API reference](/graphql/core/api-reference/graphql-api/query.mdx#ltree-operators).
...
Columns of type `jsonb` can be cast to `String` to use [text operators](/graphql/core/api-reference/graphql-api/query.mdx#text-operators) on a
`jsonb` field:
...
[TRUE expression](#pg-true-expression).
