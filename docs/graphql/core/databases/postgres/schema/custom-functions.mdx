...
exposed as top level fields in the GraphQL API (_terminology from_
...
following definitions (_this example uses the popular spatial database
extension,_ [PostGIS](https://postgis.net/)):
...
This function fetches user information (_for the given input_ `userid`)
