...
computed field to a table/view. (_terminology from_ [Postgres
...
like _Integer_, _Boolean_, _Geography_ etc. are scalar computed fields.
...
exposed as a _Boolean_ computed field on `articles`.
