...
(_You can find the older guide to do this process manually_
...
- **No action taken. Job continues to next task**
- Check your project metadata status on the console _(Settings (⚙) ->
  Metadata status)_ and attempt reloading metadata if there is an
