...
Hasura Cloud has support for _distributed tracing_, a technique for
...
Hasura will report trace information to your APM or _application
performance monitoring_ system, where it can be correlated with similar
...
correlated with each other in the APM system. This is called _trace
propagation_.
